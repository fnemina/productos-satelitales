...
def isobands(in_file, band, out_file, out_format, layer_name, attr_name, offset, interval, min_level=None):
    """
    The method that calculates the isobands
    """
    # Loading the raster file
    logger.info("Iniciando calculo de ISO Bands")
